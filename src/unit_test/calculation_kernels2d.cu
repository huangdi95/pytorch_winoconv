...
template <typename T>
__device__ void inputNorm2WinoCalculation2D_fused(T *input_patch, T *output_patch, int H, int W) {
//        output_patch[0] = input_patch[0]; 
...
template <typename T>
__device__ void outputWino2NormCalculation2D_fused(const T *input_patch, T *output_patch, int H, int W) {
//    output_patch[0] = input_patch[0];
//    output_patch[1] = input_patch[1];
//    output_patch[2] = input_patch[2];
//    output_patch[3] = input_patch[3];
