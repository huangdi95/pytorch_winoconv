 ...
 ************************************************************************/
#include "fused_transform_kernels.cu"
template<unsigned int bn, unsigned int bc, unsigned int bk, int splitH, int splitW, int loop_s, int loop_e>
__device__ __forceinline__ void kernel_16_gmem(const float *input, float *input_patch, float *input_smem, const float *weight, float *output_smem, float *agg_smem, const int *H_start, const int *W_start, const int *kernel_stride, const int xBase, const int yBase, const int nH, const int nW, const int B, const int H, const int W, const int C, const int K, const int output_H, const int output_W, const int bx, const int by, const int warp_id, const int lane_id, const int num_split) {
...
////////////////////////////////////////////////////////////////
    ...
    for (int i = 0; i < bk; i += 32) {
        ...
        __syncthreads();
        //////// output transform //////
        outputWino2NormTransform2D_fused<bn, bc, bk, splitH, splitW>(output_smem, agg_smem, kernel_stride, H_start, W_start, nH, nW, B, output_H, output_W, bx, by, 0, warp_id, lane_id, i);
        __syncthreads();
        //////////////////////////////
    }
}
...
template<unsigned int bn, unsigned int bc, unsigned int bk, int splitH, int splitW, int loop_s, int loop_e>
__device__ __forceinline__ void kernel_16_smem(const float *input, float *input_patch, float *input_smem, const float *weight, float *output_smem, float *agg_smem, const int *H_start, const int *W_start, const int *kernel_stride, const int xBase, const int yBase, const int nH, const int nW, const int B, const int H, const int W, const int C, const int K, const int output_H, const int output_W, const int bx, const int by, const int warp_id, const int lane_id, const int num_split) {
    float accu[16/8][bk] = {0};
    for (int count = C * loop_s; count < C * loop_e; count+=bc) {
        int bz = count / C;
        int i = count % C;
...
__global__ void winograd2DFused_16(const float *input, const float *weight, float *output, const int *kernel_stride, const int *H_start, const int *W_start, int nH, int nW, int B, int H, int W, int C, int K, int output_H, int output_W, int pad_h, int pad_w, int num_split) {
...
////////////////////////////////////////////////////////////////
    ...
    for (int i = 0; i < bk; i += 32) {
        ...
        __syncthreads();
        //////// output transform //////
        outputWino2NormTransform2D_fused<bn, bc, bk, splitH, splitW>(output_smem, output, kernel_stride, H_start, W_start, nH, nW, B, output_H, output_W, bx, by, 0, warp_id, lane_id, i);
        __syncthreads();
        //////////////////////////////
    }
}
...
template<unsigned int bn, unsigned int bc, unsigned int bk, int splitH, int splitW, unsigned int loop_s, unsigned int loop_e>
__global__ void winograd2DFused_8(const float *input, const float *weight, float *output, const int *kernel_stride, const int *H_start, const int *W_start, int nH, int nW, int B, int H, int W, int C, int K, int output_H, int output_W, int pad_h, int pad_w, int num_split) {
...
template<unsigned int bn, unsigned int bc, unsigned int bk, int splitH, int splitW, unsigned int loop_s, unsigned int loop_e>
__global__ void winograd2DFused_4(const float *input, const float *weight, float *output, const int *kernel_stride, const int *H_start, const int *W_start, int nH, int nW, int B, int H, int W, int C, int K, int output_H, int output_W, int pad_h, int pad_w, int num_split) {
    //TODO: when the number of warp goes down, the tiles should be less too.
    int warp_id = threadIdx.x / 32;
    int lane_id = threadIdx.x % 32;
    int bx = blockIdx.x % (K / bk);
