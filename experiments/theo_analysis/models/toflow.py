...
# Created Time: Thu 03 Dec 2020 03:47:35 PM CST
#########################################################################
import math
import torch


__all__ = ['SpyNet', 'TOFlow', 'ResNet', 'toflow_denoise', 'toflow_sr', 'toflow_interp']
...
def toflow_denoise():
    return TOFlow(256, 448, cuda_flag=True, task='denoise')

def toflow_sr():
    return TOFlow(256, 448, cuda_flag=True, task='sr')

def toflow_interp():
    return TOFlow(256, 448, cuda_flag=True, task='interp')
